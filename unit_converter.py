...
def main():
    while(True):
        ...
        if choice == "1":
            ...
            print("Meters: ", convert_km_to_m(km), " m")

        elif choice == "2":
            m = float(input("Enter meters: "))
            print("Centemeters: ", convert_m_to_cm(m), " cm")
        
        elif choice == "3":
            cm = float(input("Enter centimeters: "))
            print("Meters:", convert_cm_to_m(cm), " m")

        elif choice == "4":
            m = float(input("Enter meters: "))
            print("Kilometers:", convert_m_to_km(m), " km")

        elif choice == "5":
            kg = float(input("Enter kilograms: "))
            print("Grams:", convert_kg_to_g(kg), " g")

        elif choice == "6":
            g = float(input("Enter grams: "))
            print("Kilograms:", convert_g_to_kg(g), " kg")

        elif choice == "7":
            hours = float(input("Enter hours: "))
            print("Minutes:", convert_hours_to_minutes(hours), " mins")

        elif choice == "8":
            minutes = float(input("Enter minutes: "))
            print("Hours:", convert_minutes_to_hours(minutes), " hrs")

        elif choice == "9":
            liters = float(input("Enter liters: "))
            print("Milliliters:", convert_liters_to_ml(liters), " ml")

        elif choice == "10":
            ml = float(input("Enter milliliters: "))
            print("Liters:", convert_ml_to_liters(ml)," l")
